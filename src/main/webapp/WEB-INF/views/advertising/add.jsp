...
<link rel="stylesheet" type="text/css"
	href="/css/servicer/servicerpage.css" />
<link rel="stylesheet" type="text/css" href="/css/servicer/main.css" />
<link rel="stylesheet" type="text/css"
	href="/css/servicer/jquery.fancybox.css" />
...
<script type="text/javascript"
	src="/js/servicer/jquery.themepunch.tools.min.js"></script>
<script type="text/javascript"
	src="/js/servicer/jquery.themepunch.revolution.min.js"></script>
<script type="text/javascript"
	src="/js/servicer/imagesloaded.pkgd.min.js"></script>
...
<body style="background-image: url(../images/bg-1.jpg);">
				...
				<div class="row">
					...
					<div class="col-sm-6 text-right">
						<div class="top-right-wrap">
							<div class="top-login">
								<i class="flaticon-people-2"></i>登录
							</div>
							<span>|</span>
                  ...
                  <aside class="widget-top-sellers #cart-menu">
                    ...
                    <div class="cart-buttons"><a href="cart.html" class="cws-button alt mini">View Cart</a><a href="checkout.html" class="cws-button mini">Checkout</a></div>
							...
							<div class="top-search">
								<i class="flaticon-interface"></i>搜索
							</div>
						</div>
					</div>
					<div class="search_menu_cont">
						<form role="search" method="get" class="form">
							<div class="search-wrap">
								<input type="text" placeholder="输入需要查找的内容. . ."
									class="form-control search-field">
							</div>
						</form>
						<div class="search_back_button">
		...
		<nav class="main-nav js-stick">
			<div class="full-wrapper relative clearfix container">
				...
				<div class="nav-logo-wrap local-scroll">
					<a href="<%=basePath%>/common/home/index.hjrz" class="logo"><img
						src="/images/hjrzlogo.png" style="width: 190px; height: 47px;"
						data-at2x="/images/hjrzlogo.png" alt><img
						src="/images/hjrzlogo.png" style="width: 190px; height: 47px;" alt
						class="sticky-logo"></a>
				</div>
				<!-- Main Menu-->
				<div class="inner-nav desktop-nav switch-menu">
					...
					<div class="menu-contacts">
						<div class="menu-contacts-item">
							<i class="glyphicon glyphicon-tasks cws-icon"></i>
							<p class="mb-0">GPU服务器</p>
							<p class="mb-0">共-0-台</p>
						</div>
						<div class="menu-contacts-item">
							<i class="glyphicon glyphicon-earphone cws-icon"></i>
							<p class="mb-0">客户服务电话</p>
							<p class="mb-0">13177536625</p>
						</div>
						<div class="menu-contacts-item">
							<i class="glyphicon glyphicon-user cws-icon"></i>
							<p class="mb-0">未登录</p>
							<p class="mb-0">xxx</p>
						</div>
					</div>
	...
	<div class="container" style="margin-top: 70px;">
		<div class="navbar-wrapper">
			<div class="col-sm-3 col-sm-offset-1 blog-sidebar"
				...
				<div class="sidebar-module sidebar-module-inset">
					...
					<ol class="list-unstyled">
						<c:forEach items="${servertype}" var="s" begin="0"
							varStatus="status">
			...
			<div class="row">
				<div
					class="col-md-7 col-sm-7 sidebar-module-inset blog-main pull-left">
					<div>${webcontext}</div>
				</div>
